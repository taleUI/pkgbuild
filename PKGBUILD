...
license=('MIT' 'MPL2')
depends=('libgl' 'libev' 'pcre' 'libx11' 'xcb-util-renderutil' 'libxcb' 'xcb-util-image' 'libxext' 'pixman' 'libconfig' 'libdbus' 'hicolor-icon-theme')
...
package() {
  ...
  install -D -m644 "picom.sample.conf" "${pkgdir}/etc/skel/.config/picom.conf"
}
